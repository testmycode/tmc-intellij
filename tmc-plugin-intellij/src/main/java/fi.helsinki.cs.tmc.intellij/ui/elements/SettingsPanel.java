...
public class SettingsPanel {
    ...
    private ComboBox listOfAvailableCourses;
    ...
    private ComboBox selectErrorLanugageField;
    // POISTA TÄMÄ
    ...
    public ComboBox getListOfAvailableCourses() {
    ...
    public ComboBox getSelectErrorLanugageField() {
        return selectErrorLanugageField;
    }
    ...
    public SettingsPanel() {
        ...
        course.setName("nimi of course");
        courses.add(course);
        course.setName("coursesse");
//        courses = saveSettings.getCourses();
//        if (courses == null) {
//            courses.add(course);
//            courses.add(course);
//        }
...
//        courses = (ArrayList<Course>) tmc.listCourses(ProgressObserver.NULL_OBSERVER);
        ...
        projectPathField.setText("NOT DEFINED YET ! ! ! ! ! ! ! !");
        selectErrorLanugageField.addItem("English");
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        listOfAvailableCourses = new ComboBox();
        ...
        panel1.add(button1, new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JSeparator separator1 = new JSeparator();
        panel1.add(separator1, new GridConstraints(4, 1, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        ...
        panel1.add(separator2, new GridConstraints(6, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        ...
        panel1.add(separator3, new GridConstraints(10, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        selectErrorLanugageField = new ComboBox();
        panel1.add(selectErrorLanugageField, new GridConstraints(11, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText("Preferred error message language");
